...
mkdir $TMPDIRS
echo "Job $JOB_ID is executed on $HOSTNAME, command: ./convergence.py 0.3 1>convergence.out 2>convergence.err"
./convergence.py 0.3 1>convergence.out 2>convergence.err
